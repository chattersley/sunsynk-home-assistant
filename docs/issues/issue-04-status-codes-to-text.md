...
|---|---|---|---|
| `sensor.sunsynk_gateway_e4701229q568_status` | `2` | — | Gateway status |
| `sensor.sunsynk_inverter_2210085392_battery_status` | `2` | — | |
| `sensor.sunsynk_inverter_2210085392_grid_status` | `-1` | — | |
| `sensor.sunsynk_inverter_2210085392_smart_load_status` | `-1` | — | |
| `select.sunsynk_inverter_2210085392_system_work_mode` | `0` | options `["0","1","2","3"]` | Already writable, but labels are raw numbers |
