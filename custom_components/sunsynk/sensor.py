...
def _create_inverter_sensors(
    ...
    if inv_data.get("settings"):
        settings_defs: list[tuple[str, str]] = [
            ...
            ("sell_time1on", "settings_sell_time_1_on"),
            ("sell_time2on", "settings_sell_time_2_on"),
            ("sell_time3on", "settings_sell_time_3_on"),
            ("sell_time4on", "settings_sell_time_4_on"),
            ("sell_time5on", "settings_sell_time_5_on"),
            ("sell_time6on", "settings_sell_time_6_on"),
